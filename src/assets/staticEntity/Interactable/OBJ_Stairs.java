...
public class OBJ_Stairs extends InteractableEntity {
    ...
    public void setupImages() {
        image = Utils.setupImage("/Images/Assets/Objects/stairs_down", ref.settings.tileSize, ref.settings.tileSize);
        image2 = Utils.setupImage("/Images/Assets/Objects/stairs_up", ref.settings.tileSize, ref.settings.tileSize);
    }
